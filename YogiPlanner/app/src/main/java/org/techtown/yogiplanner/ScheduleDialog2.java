                            ...
                            .setPositiveButton("확인", new DialogInterface.OnClickListener(){
                                ...
                                public void onClick(DialogInterface dialog, int which){
                                    if(items[selectedItem[0]] == "이 일정만 삭제"){ //이건 계속 갱신 됨
                                        ...
                                        ((MainActivity)MainActivity.mContext).deleteSchedule2(WeekFragment.passedIndex, 2);}
                                    else if(items[selectedItem[0]] == "전체 반복 일정 삭제"){
                                        ((MainActivity)MainActivity.mContext).deleteSchedule2(WeekFragment.passedIndex, 3);}
                                }
                            })
